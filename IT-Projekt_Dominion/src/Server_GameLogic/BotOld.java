 ...
 */
public class BotOld extends Player {
...
//			this.actualPhase = "play";
	...
	private void makeabreak() {
		...
		int time = rand.nextInt(MAX_TIME_BEFORE_EXECUTING - MIN_TIME_BEFORE_EXECUTING) + MIN_TIME_BEFORE_EXECUTING;
		try {
			Thread.sleep(time);
